...
void sfr_config_init()
{
  ...
  control_parameter_add3(control_parameter_double,&sfr.U_MW,"sfr:U_MW","sfr.U_MW","sf:recipe=2:U_MW","If positive, choose a constant value for the U_MW in Gnedin & Kravtsov 2010 eq 6. If negative you are selecting an estimate for U_MW based on the SFR smoothed on some scale... (under development).");

  control_parameter_add3(control_parameter_double,&sfr.D_MW,"sfr:D_MW","sfr.D_MW","sf:recipe=2:D_MW","If positive, choose a constant value for the D_MW in Gnedin & Kravtsov 2010 eq 6. If negative or zero you are selecting an estimate for D_MW based on the cell metallicity.");
}
