...
void hartold_config_init()
{
    control_parameter_add4(control_parameter_time,&sf_timescale,"sf_timescale","sf_timescale","sf_timescale","tau_SF","the timescale for star formation. Star formation in a given cell is assumed to continue with the constant rate for that period of time.");
    
    control_parameter_add4(control_parameter_double,&sf_min_stellar_particle_mass,"sf_min-stellar-particle-mass","sf_min_stellar_particle_mass","sf_min_stellar_particle_mass","dm_star_min","minimum mass for a newly created stellar particle, in solar masses. This value should be small enough to avoid artifically boosting the SFR in the low density gas.");

}

void hartold_config_verify()
{
...
void hartold_star_formation( int level, int icell, double dtl, double dt_eff, double sfr )
{
    int i;
    double mstar;
    double P_SF, P_mass;
