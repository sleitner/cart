...
//  Fortran interface 
*/
void frtCall(coolingrate)(frt_real *rPar, frt_real *rRadField0, frt_real *rRadField1, frt_real *rVar, frt_real *rateCool, frt_real *rateHeat);
...
frt_real frtCall(dusttogas)(frt_real *Zsol);
...
#if (RT_CFI == 1)
void frtCall(transfercomputecellabs)(frt_intg *L, frt_real *Zsol, frt_real *denB, frt_real *denH1, frt_real *denG1, frt_real *denG2, frt_real *denMH, frt_real *dx, frt_real *abc, frt_real *abc1);
#else
void frtCall(transfercomputecellabs)(frt_intg *L, frt_real *Zsol, frt_real *denB, frt_real *denH1, frt_real *denG1, frt_real *denG2, frt_real *denMH, frt_real *dx, frt_real *abc);
#endif
