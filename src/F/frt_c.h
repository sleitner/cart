...
#else
void frtCall(transfercomputecellabs)(frt_intg *L, frt_real *denB, frt_real *denHI, frt_real *denHeI, frt_real *denHeII, frt_real *denMH, frt_real *dx, frt_real *abc, frt_real *Zsol);
#endif
#endif
