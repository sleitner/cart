...
void frtCall(stepend)(frt_real *vol, frt_real *avg);
void frtCall(updatetables)();
...
void frtCall(stepbegintransfer)();
...
/*
//  These two functions are not part of the package, they need to be added
*/
#ifdef RT_TRANSFER
