...
d_flag[idRT_CFI] = 0;
#endif
#define idRT_CHEMISTRY  37
#ifdef RT_CHEMISTRY
d_flag[idRT_CHEMISTRY] = 1;
#else
d_flag[idRT_CHEMISTRY] = 0;
#endif
#define idRT_CHEMISTRY_MINIMAL_MODEL  38
